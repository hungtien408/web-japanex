<%@ Control Language="C#" AutoEventWireup="true" CodeFile="XuatHoaDon.ascx.cs" Inherits="uc_XuatHoaDon" %>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="get_xuathoadon"
    TypeName="TableXuatHoaDon" DeleteMethod="delete_xuathoadon">
    <DeleteParameters>
